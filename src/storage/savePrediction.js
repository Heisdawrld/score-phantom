...
export async function initPredictionsTable() {
  ...
  await db.execute(`
    CREATE TABLE IF NOT EXISTS predictions_v2 (
      ...
      best_pick_raw_probability REAL,
    ...
    await db.execute({
      sql: `
        INSERT INTO predictions_v2 (
          ...
          best_pick_market, best_pick_selection, best_pick_probability, best_pick_raw_probability,
          ...
          best_pick_raw_probability = EXCLUDED.best_pick_raw_probability,
