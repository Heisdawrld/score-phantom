...
2. PERFORMANCE DATA - form, goals, home/away strength, H2H patterns, attack vs defense mismatch
3. GAME SCRIPT - predict how the match plays out: one-sided dominance? open attacking? cagey/defensive?
4. MARKET - evaluate 1X2, Over/Under, BTTS, Handicap, Team Goals. Pick ONE with CLEAR edge.
5. INTELLIGENT RISK - Over 2.5, BTTS, Handicap are valid if data supports. Avoid Over 0.5 unless truly the only logical pick.
