...
async function insertEvents(events) {
  ...
  for (const event of events) {
    ...
    try {
      await db.batch([
        {
          sql: 'INSERT INTO teams (id, name, short_name) VALUES (?, ?, ?) ON CONFLICT (id) DO NOTHING',
        ...
        {
          sql: 'INSERT INTO tournaments (id, name, category, url) VALUES (?, ?, ?, ?) ON CONFLICT (id) DO NOTHING',
