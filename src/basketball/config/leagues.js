export const BASKETBALL_LEAGUES = {
  nba: {
    ...
    // V2 data source hierarchy: NBA Stats API (free, deep) → ESPN (free, broad) → BallDontLie (key required) → API-Sports (odds)
    dataSource: 'nba_stats_api',
    espnLeague: 'nba',
    enabled: true,
    launchTier: 'v1',
    minDataQuality: 0.55,
  ...
  ncaab: {
    ...
    // V2 data source: ESPN (free, broad) → API-Sports (odds + backup)
    dataSource: 'espn',
    espnLeague: 'ncaab',
    enabled: true,
    launchTier: 'v1',
