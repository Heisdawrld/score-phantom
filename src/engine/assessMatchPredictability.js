...
export function assessMatchPredictability(features, script, calibratedProbs) {
  ...
  // 1. Low data completeness (Restored to 0.35)
  ...
  // 2. Chaotic script with high confidence (Restored to 0.65)
  ...
  // 3. Extreme chaos score (Restored to 0.88)
  ...
  // 4. High upset risk + weak data (Restored to 0.75/0.55)
