...
export default function DailyAcca() {
  ...
  return (
    <div className="acca-2627 flex flex-col min-h-screen bg-[#060a0e] text-white selection:bg-primary/30 relative">
      ...
      <div className="flex-1 w-full max-w-4xl mx-auto px-4 pb-24 relative z-10">
